...
% -------------------------------------------------------------------------
%
% Outputs:              m.CoordSys.a1       - not req. after simplifications
%                       m.CoordSys.a2       - not req. after simplifications
%                       m.CoordSys.a3       - not req. after simplifications
%                       m.CoordSys.c1       - req.
...
%     end     % K - number of blades
    ...
    %% Check
%     global SCS1
%         SCS1    = [SCS1, (1*p.CShftTilt.*m.CoordSys.rf1 + p.SShftTilt.*m.CoordSys.rf2 + 0*m.CoordSys.rf3)'];        % 1st: 9.9406e-01; 2nd: -1.0880e-01; 3rd: 0

    %% Simplified
    m.CoordSys.c1   = [9.9406e-01, -1.0880e-01, 0];
